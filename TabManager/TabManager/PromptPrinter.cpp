...
void PromptPrinter::operator()()
{
	...
	std::cout << "> GO <Enter> <url> -> load current tab with <url>" << std::endl;
	std::cout << "> INSERT <Enter> <url> -> insert a tab with <url> after current ";
	...
	std::cout << "> SEARCH <Enter> <word> -> search for <word> in all opened tabs";
